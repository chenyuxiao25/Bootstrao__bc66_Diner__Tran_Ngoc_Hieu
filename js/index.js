...
document.getElementById("switchButton").onclick = function () {
    ...
    document.getElementById("header-title").classList.toggle("dark");
    document.getElementsByClassName(".light-turn").classList.toggle("dark");
    document.getElementsByClassName(".box-wrap ").classList.toggle("dark");
    document.getElementsByClassName(".counter ").classList.toggle("dark");
